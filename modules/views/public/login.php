    ...
    <body>
        <div class="row-fluid login-wrapper">
            ...
            <?php $form = ActiveForm::begin([
                    'fieldConfig' =>[
                        'template' => '<p class="help-block help-block-error">{error}</p>{input}',
                    ]
                ]);?>
                <div class="span4 box">
                    <div class="content-wrap">
                        ...
                        <div class="form-group field-remember-me">
                            <div class="remember">
                                <?php echo $form->field($model,'reMember')->checkBox(['template'=>'{input}<label for="remember-me">记住我</label>','checked'=>'checked']);?>
                            </div>
                        </div>
